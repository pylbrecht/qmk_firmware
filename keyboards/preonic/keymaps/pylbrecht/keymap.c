...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_ESC,  KC_A,    HRM_S,    HRM_D,   HRM_F,   KC_G,    KC_H,    HRM_J,   HRM_K,   HRM_L,    KC_SCLN, CW_TOGG,
  _______, CTL_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  CTL_T(KC_SLSH), _______,
  OSM(MOD_LCTL | MOD_LSFT), KC_LCTL, KC_LGUI, _______, LOWER,   KC_SPC,  KC_SPC,  XXXXXXX,   KC_TAB, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_SYMBOLS] = LAYOUT_preonic_grid(
  ...
  _______, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_TILD, _______, _______, _______, KC_UNDS, _______, _______,
